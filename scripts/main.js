...
function loadExampleDiagram() {
    ...
    const exampleData = {
        "nodes": [
            {"id": "eks-cluster", "label": "EKS Cluster", "subtitle": "innovate-prod", "icon": "./assets/icons/AWS/eks-cluster.png", "type": "container"},
            ...
            {"id": "ingress", "label": "AWS Load Balancer Controller", "subtitle": "Ingress Controller", "icon": "./assets/icons/Kubernetes/ingress.svg", "parentNode": "ns-system"},
            {"id": "backend-deploy", "label": "Backend Deployment", "subtitle": "Flask API", "icon": "./assets/icons/General/backend-deploy.png", "parentNode": "ns-prod"},
            {"id": "frontend-deploy", "label": "Frontend Deployment", "subtitle": "React SPA", "icon": "./assets/icons/General/frontend-deploy.png", "parentNode": "ns-prod"},
            {"id": "worker-deploy", "label": "Worker Deployment", "subtitle": "Background Jobs", "icon": "./assets/icons/General/worker-deploy.png", "parentNode": "ns-prod"},
            {"id": "backend-svc", "label": "Backend Service", "subtitle": "ClusterIP", "icon": "./assets/icons/General/backend-svc.png", "parentNode": "ns-prod"},
            {"id": "frontend-svc", "label": "Frontend Service", "subtitle": "ClusterIP", "icon": "./assets/icons/General/frontend-svc.png", "parentNode": "ns-prod"},
            {"id": "redis-svc", "label": "Redis Service", "subtitle": "External Service", "icon": "./assets/icons/General/redis-svc.svg", "parentNode": "ns-prod"},
            {"id": "db-secret", "label": "Database Secret", "subtitle": "RDS Credentials", "icon": "./assets/icons/General/db-secret.png", "parentNode": "ns-prod"},
            {"id": "app-config", "label": "App ConfigMap", "subtitle": "Environment Config", "icon": "./assets/icons/General/app-config.png", "parentNode": "ns-prod"},
            {"id": "prometheus", "label": "Prometheus", "subtitle": "Metrics Collection", "icon": "./assets/icons/Monitoring/prometheus.png", "parentNode": "ns-monitoring"},
            {"id": "grafana", "label": "Grafana", "subtitle": "Dashboards", "icon": "./assets/icons/Monitoring/grafana.png", "parentNode": "ns-monitoring"},
            {"id": "fluentbit", "label": "Fluent Bit", "subtitle": "Log Collection", "icon": "./assets/icons/Kubernetes/fluentbit.svg", "parentNode": "ns-monitoring"},
            {"id": "cluster-autoscaler", "label": "Cluster Autoscaler", "subtitle": "Node Scaling", "icon": "./assets/icons/Kubernetes/cluster-autoscaler.svg", "parentNode": "ns-system"},
            {"id": "external-dns", "label": "External DNS", "subtitle": "DNS Management", "icon": "./assets/icons/Kubernetes/external-dns.svg", "parentNode": "ns-system"}
        ],
        "edges": [
